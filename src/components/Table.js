    ...
    <div>
      ${this.paginated_data.length > 0 ? 
            ...
            (row) =>  html`
              ...
              <div class="md:py-2 md:px-4">${row.ln}</div>

              <div class="md:hidden font-semibold">Prenom</div>
              <div class="md:py-2 md:px-4">${row.fn}</div>
              
              <div class="md:hidden font-semibold">Motif</div>
              <div class="md:py-2 md:px-4">${row.reason}</div>

              <div class="md:hidden font-semibold">Date</div>
                <div class="md:py-2 md:px-4">${row.date}</div>
